...
export interface IDashboardOps {
    getHistoryData(ekycId: number,props: IEkycApprovalTruboreProps): Promise<IHistory[]>;
    insertHistoryData(item: KYCData, props: IEkycApprovalTruboreProps): Promise<any>;
...
export default function HistoryOps(): IDashboardOps {
    ...
    const getHistoryData = async (ekycId: number, props: IEkycApprovalTruboreProps): Promise<IHistory[]> => {
    ...
    const insertHistoryData = async (item: KYCData, props: IEkycApprovalTruboreProps): Promise<any> => {
        try {
            const spCrudOpsInstance = await spCrudOps;
