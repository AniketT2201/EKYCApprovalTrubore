...
export interface IDashboardOps {
    getDashboardData(props: IEkycApprovalTruboreProps): Promise<IEKYC[]>;
  ...
  getDashboardItemById(listName: string ,id: number, props: IEkycApprovalTruboreProps): Promise<IEKYC>;
  insertDashboardData(item: IEKYC, props: IEkycApprovalTruboreProps): Promise<any>;
  updateDashboardData(id: number, item: IEKYC, props: IEkycApprovalTruboreProps): Promise<void>;
  preFillData(code: string, props: IEkycApprovalTruboreProps): Promise<{EmployeeName?: string; Department?: string}>;
...
export default function DashboardOps(): IDashboardOps {
    ...
    const getDashboardData = async ( props: IEkycApprovalTruboreProps): Promise<IEKYC[]> => {
    ...
    const preFillData = async (code: string, props: IEkycApprovalTruboreProps): Promise<{EmployeeName?: string; Department?: string}> => {
        try {
    ...
    const insertDashboardData = async (item: IEKYC, props: IEkycApprovalTruboreProps): Promise<any> => {
        try {
            const spCrudOpsInstance = await spCrudOps;
    ...
    const updateDashboardData = async (id: number, item: IEKYC, props: IEkycApprovalTruboreProps): Promise<void> => {
        try {
            const spCrudOpsInstance = await spCrudOps;
    ...
    const getAttachments = async (
        listName: string,
        itemId: number,
        props: IEkycApprovalTruboreProps
