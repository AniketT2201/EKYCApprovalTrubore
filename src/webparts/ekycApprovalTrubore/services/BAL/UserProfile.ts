...
export interface UserProfileOps {
    getLoggUserProfile(props: IEkycApprovalTruboreProps): Promise<IUserProfile>;
}

export default function LoggUserProfileOps() {
    const spCrudOps = SPCRUDOPS();
        const getLoggUserProfile = async (props: IEkycApprovalTruboreProps): Promise<IUserProfile> => {
