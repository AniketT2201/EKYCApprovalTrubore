...
export async function getHttpData(endpoint: string, props: IEkycApprovalTruboreProps): Promise<any> {
...
// // GET
//     async getHttpData(endpoint: string, props: IEkycApprovalTruboreProps): Promise<any> {
//         if (!props.currentSPContext) {
//             throw new Error("SP Context not available");
//         }
//         const response: HttpClientResponse = await props.currentSPContext.httpClient.get(
...
//     // PUT
//     async updateHttpData(endpoint: string, data: any, props: IEkycApprovalTruboreProps): Promise<any> {
//         if (!props.currentSPContext) {
//             throw new Error("SP Context not available");
//         }
...
//     // DELETE
//     async deleteHttpData(endpoint: string, props: IEkycApprovalTruboreProps): Promise<any> {
//         if (!props.currentSPContext) {
//             throw new Error("SP Context not available");
//         }
//         const response: HttpClientResponse = await props.currentSPContext.httpClient.fetch(
