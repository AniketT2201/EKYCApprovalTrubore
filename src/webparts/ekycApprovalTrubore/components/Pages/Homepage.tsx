...
import '../styles.scss';
import type { IEkycApprovalTruboreProps } from '../IEkycApprovalTruboreProps';
...
export const Homepage: React.FunctionComponent<IEkycApprovalTruboreProps> = (props: IEkycApprovalTruboreProps) => {
...
const validateForm = () => {
  ...
  return (
    <div className={`pageContainer `}>
      ...
      <div>
        <h1 className={`main-heading fade-in ${visible ? 'visible' : ''}`} style={{ transitionDelay: '1.6s'}}>E-KYC Dashboard Trubore</h1>
      </div>
        ...
        <div className="popup-overlay">
          <div className="popup-card">
            <div className="popup-header">
              <h3>{isViewMode ? "View New KYC-Prince" : (isEditMode ? "Update New KYC-Prince" : "Create New KYC-Prince")}</h3>
