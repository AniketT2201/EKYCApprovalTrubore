...
import styles from './EkycApprovalTrubore.module.scss';
...
export default class EkycApprovalTrubore extends React.Component<IEkycApprovalTruboreProps> {
  public render(): React.ReactElement<IEkycApprovalTruboreProps> {
    const {
      description,
      isDarkTheme,
      environmentMessage,
    ...
    return (
      <section className={`${styles.ekycApprovalTrubore} ${hasTeamsContext ? styles.teams : ''}`}>
        <ParallaxProvider>
          <HashRouter>
